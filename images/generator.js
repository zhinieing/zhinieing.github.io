    ...
    var restful = cfg.hasOwnProperty('restful') ? cfg.restful :
        ...
        postMap = function (post) {
            return {
                ...
                cover: posts_props('cover', cfg.restful.cover_prefix + post.cover || fetchCover(post.content)),
            ...
            return cates.reduce(function (result, item) {
                ...
                return result.concat(pagination(item.path, posts, {
                    ...
                    data: {
                        ...
                        cover: cfg.restful.cover_prefix + kind + '/' + name + '.jpg',
                        postlist: item.posts.sort('-date').map(postMap)
                    }
        ...
        apiData = apiData.concat(posts.map(function (post) {
            ...
            return {
                ...
                data: JSON.stringify({
                    ...
                    slug: post.slug,
                    date: post.date,
                    cover: cfg.restful.cover_prefix + post.cover,
